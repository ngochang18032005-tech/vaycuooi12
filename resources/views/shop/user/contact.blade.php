...
<div class="container-fluid pt-5">
    <div class="text-center mb-4">
        <h2 class="section-title px-5"><span class="px-2">Hãy gửi thắc mắc của bạn cho tôi</span></h2>
    </div>
    <div class="row px-xl-5">
        ...
        <div class="col-lg-5 mb-5">
            ...
            <div class="d-flex flex-column mb-3">
                ...
                <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>Quận 1, TP.Hồ Chí Minh, Việt Nam</p>
