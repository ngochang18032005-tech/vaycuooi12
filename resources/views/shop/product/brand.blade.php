...
<div class="container-fluid pt-5">
    <div class="mb-4">
        <h2>
            ...
            Sản phẩm thuộc thương hiệu: {{ $selectedBrand->name }}
            @else
    ...
    <div class="mb-4">
        ...
        <div class="row px-xl-5 pb-3">
            ...
            @empty
            <p class="px-3">Không có sản phẩm trong danh mục này.</p>
            @endforelse
        </div>
    </div>
    @endforeach
    @else
    <p>Không có danh mục nào chứa sản phẩm thuộc thương hiệu này.</p>
    @endif
</div>
